...
- (void)setPassword:(NSString *)password {
    [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%@",password] forKey:@"password"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
-(void)uploadDeviceToken
{
    if (self.isLogin&&self.session_token&&self.deviceToken)
    {
        ...
        [zkRequestTool networkingPOST:[QYZJURLDefineTool user_upUmengURL] parameters:dic success:^(NSURLSessionDataTask *task, id responseObject) {
